...
public class GoogleMapComponent extends C2CMapComponent {
    ...
    public GoogleMapComponent(WgsBoundingBox bbox, WgsPoint middlePoint, int width, int height,
            int zoom) {
            ...
            if (toRetrieve.isValid()) {
                String url = MessageFormat
                        .format(
                                ...
                                toRetrieve.center.getLat(), toRetrieve.center.getLon(),
                                toRetrieve.zoom, toRetrieve.width, toRetrieve.height);
